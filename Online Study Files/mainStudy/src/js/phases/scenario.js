...
const different_futureSocieties = {
  ...
  moderngreen: {
    ...
    Vignette_text1: introText,
    Vignette_text2:
      "Living together centers on sustainability combined with economic security, using selective and limited green technology to maintain long-term human–nature balance while avoiding poverty. Legitimate authority rests on institutions and shared moral commitments that support a well-functioning society with shared resources. Ecological sustainability targets make environmental protection a primary goal that guides what the society tries to achieve. Sufficiency orientation sets “just enough” as the guiding principle for what people aim to use and consume. Laws and institutions are arranged in a way to keep the society working reliably while balancing human desires and limited natural resources.",
    Vignette_text3:
  ...
  lawBased: {
    ...
    Vignette_text1: introText,
    Vignette_text2:
      "Robust institutions and clear legal frameworks regulate behavior and coordinate collective life assuming that humans are not flawless and can make mistakes. Legitimate authority comes from the rule of law with enforceable sanctions, aiming at stability and predictability through a government of laws rather than persons. The laws are clear, so people are expected to know their duties and what they are allowed to do. Behavior is guided by external rules and transparent consequences rather than by people’s inner moral perfection. There are real penalties for breaking the rules to maintain obedience and reduce deviant behavior.",
    Vignette_text3:
