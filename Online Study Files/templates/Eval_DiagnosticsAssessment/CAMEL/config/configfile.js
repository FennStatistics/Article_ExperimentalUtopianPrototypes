...
/* default values */
var config = {
    CAMproject: "Evaluation Diagnostic", // "proj_" + uuid.v4(), // necessary for server (see ERM) !!!
    MinNumNodes: 20, // number of nodes necessary to draw # !!! 8
    
    enableArrows: true, // if false = possible to draw arrows
    ...
    MultiComponentStudy: true // only works if usingJATOS is set to "true", set "AdaptiveStudy" to false
}
