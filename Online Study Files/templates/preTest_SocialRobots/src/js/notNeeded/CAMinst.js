...
const textObjInstCAM = {
    ...
    <header>
    <h2 id="head0">
    Bitte lesen Sie die folgende Anleitung aufmerksam durch, damit Sie wissen wie man eine <i>Cognitive-Affective Map</i> erstellt:
    </h2>
  ...
  <main class="content-horizontal-center content-vertical-center">
    ...
    In der folgenden Anleitung wird erklärt, wie man eine <i>Cognitive-Affective Map</i> erstellt. Für die Erklärung der Software haben wir für Sie ein themenfernes Beispiel erstellt, nämlich den Einkauf auf dem Markt. Die Instruktionen sind hierbei <strong>auf Englisch</strong> (die Instruktionen sollen über die verschiedenen <i>Cognitive-Affective Map</i> Studien konstant gehalten werden).
    <br>
    <br>
    <i>Verwenden Sie die Pfeiltaste <kbd>&rarr;</kbd>, um alle Anweisungen zu lesen. Jederzeit können Sie durch die Pfeiltaste <kbd>&larr;</kbd> die Instruktionen erneut lesen. </i>
    <br>
    <br>
    <br>
    Drücken Sie die rechte Pfeiltaste <kbd>&rarr;</kbd>, um mit dem Lesen der Instruktionen zu beginnen.
    </section>
  ...
  <footer>
    <table class="table-plain">
      <tr>
        ...
        Drücken Sie die linke Pfeiltaste <kbd>&larr;</kbd>, um zum vorherigen Bildschirm zu gelangen 
        </td>
        <td id="done" style="visibility: hidden">
        Drücken Sie die <kbd>Leertaste</kbd>, um fortzufahren 
        </td>
        <td id="fwd">
        Drücken Sie die rechte Pfeiltaste <kbd>&rarr;</kbd> für den nächsten Bildschirm 
        </td>
      </tr>
    </table>
  </footer>`
